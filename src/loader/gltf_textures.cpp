...
{
    const uint32_t LUT_SIZE = 512; // or 256

    state->texture->lutFormat = VK_FORMAT_R16G16_SFLOAT;
    state->texture->lutMipLevels = 1;
...
void textureImageCreate(
    ...
    printf("BRDF LUT format: %d, mipLevels: %d\n", outFormat, outMipLevels);
